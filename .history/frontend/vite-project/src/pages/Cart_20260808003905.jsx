  ...
  useEffect(() => {
    ...
    const fetchRecommended = async () => {
      try {
        ...
        const res = await API.get("products/", { params: PRODUCT_FILTERS.BEST_SELLER });
          ...
          <div className="row g-4 sz-cart-layout">
            ...
            <div className="col-lg-4 sz-cart-sidebar">
              <div className="sz-cart-summary-wrapper">
                ...
                <div className="sz-trust-strip p-3 bg-light rounded-3 border d-flex align-items-start gap-2">
