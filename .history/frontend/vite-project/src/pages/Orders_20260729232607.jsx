    ...
    <StoreShell>
      <div className="orders-container px-3 px-md-0">
        ...
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-4">
          ...
          <h1 className="display-6 fw-extrabold mb-2 orders-title">My Orders</h1>
        ...
        {loading ? (
          <div className="text-center py-5">
            <div className="spinner-border text-primary order-spinner" role="status">
              ...
              >
                ...
                <div className="order-header-interactive" onClick={() => toggleExpand(order.id)}>
                  ...
                  <div className="d-flex align-items-center gap-3 mt-2 mt-sm-0">
                    ...
                    <b className="fs-5 order-total-price">
                      ...
                      <div className="p-4 border-top">
                        ...
                        {order.status !== "Cancelled" ? (
                          <div className="stepper-wrapper p-3 mb-4">
                            ...
                            <div className="text-center mt-2">
                              <span className="small text-muted font-weight-medium d-inline-flex align-items-center gap-1">
                                {order.status === "Pending" && (
                                  <>
                                    <FaRocket className="text-warning" /> Your order is being prepared and will ship soon.
                                  </>
                                )}
                                {order.status === "Shipped" && (
                                  <>
                                    <FaShippingFast className="text-primary" /> Package is in transit. Est. delivery: 2-3 business days.
                                  </>
                                )}
                                {order.status === "Delivered" && (
                                  <>
                                    <FaGift className="text-success" /> Delivered! We hope you love your new gear.
                                  </>
                                )}
                              </span>
                            </div>
                        ...
                        <div className="mb-4">
                          ...
                          {order.items?.map((item, index) => (
                            <div
                              key={item.id}
                              className={`d-flex flex-wrap align-items-center gap-3 py-3 ${index !== order.items.length - 1 ? "border-bottom" : ""
                                }`}
                            >
                              
                                href={`/shop`}
                                className="rounded-3 bg-light d-flex align-items-center justify-content-center p-2 flex-shrink-0 border order-item-thumb"
                              >
                                <img
                              ...
                              <div className="flex-grow-1 min-w-0">
                                <h6 className="fw-bold mb-1 text-truncate order-item-name">
                                  {item.product_name}
                                </h6>
                                <div className="d-flex flex-wrap align-items-center gap-2 text-muted small">
                                  {item.selected_size && item.selected_size !== "N/A" && (
                                    <>
                                      <span>
                                        Size: <b className="text-dark">{item.selected_size}</b>
                                      </span>
                                      <span>•</span>
                                    </>
                                  )}
                            ...
                            <div className="bg-light p-3 rounded-3 border h-100">
                              <div className="info-content-text">
                                ...
                                <div className="mb-2">
                                  ...
                                  <div>
                                    <span
                                      className={`badge rounded-pill px-2.5 py-1 payment-status-badge ${order.payment_status === "Paid"
                                          ? "bg-success"
                                ...
                                {order.payment_completed_at && (
                                  <div>
                                    <span className="text-muted small block">Paid At:</span>
          ...
          <div className="sz-modal-overlay">
            ...
            >
              <div className="text-center">
                <div className="bg-danger-subtle text-danger rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3 cancel-icon-circle">
                ...
                <div className="text-start border rounded-3 p-3 mb-4 bg-light cancel-items-list">
                  ...
                  {orderToCancel.items?.map((item) => (
                    <div key={item.id} className="d-flex align-items-center gap-2 mb-2 pb-2 border-bottom last-border-0">
                      <div className="rounded border bg-white d-flex align-items-center justify-content-center flex-shrink-0 cancel-item-thumb">
                        <img
                          src={mediaUrl(item.product_image) || "/no-image.png"}
                          alt=""
                          className="thumb-img"
                      ...
                      <div className="flex-grow-1 min-w-0">
                        <div className="small fw-bold text-truncate cancel-item-name">{item.product_name}</div>
                        <div className="text-muted extra-small cancel-item-meta">
                          Qty: {item.quantity}
