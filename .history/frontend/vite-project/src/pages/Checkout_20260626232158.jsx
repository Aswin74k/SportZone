    ...
    <StoreShell>
      <div className="sz-co-page">
        <div className="sz-co-wrap">
          ...
          <nav className="sz-co-progress" aria-label="Checkout progress">
            <button
              type="button"
              className={`sz-co-progress-step ${addressComplete ? "done" : "current"}`}
              onClick={() => handleStepClick("address")}
            >
              <span className="sz-co-progress-dot">1</span>
              <span className="sz-co-progress-label">Address</span>
            </button>

            <span className={`sz-co-progress-line ${addressComplete ? "done" : ""}`} />

            <button
              type="button"
              className={`sz-co-progress-step ${
                activeStep === "review" || activeStep === "payment" ? "done" : ""
              } ${activeStep === "review" ? "current" : ""}`}
              onClick={() => handleStepClick("review")}
              disabled={!addressComplete}
            >
              <span className="sz-co-progress-dot">2</span>
              <span className="sz-co-progress-label">Review</span>
            </button>

            <span className={`sz-co-progress-line ${activeStep === "payment" ? "done" : ""}`} />

            <button
              type="button"
              className={`sz-co-progress-step ${activeStep === "payment" ? "current" : ""}`}
              onClick={() => handleStepClick("payment")}
              disabled={!addressComplete}
            >
              <span className="sz-co-progress-dot">3</span>
              <span className="sz-co-progress-label">Payment</span>
            </button>
          </nav>
          ...
          <div className="row g-4">
            ...
            <div className="col-lg-8">
              ...
              <div className={`sz-co-step-card ${activeStep === "address" ? "active" : ""} ${addressComplete ? "completed" : ""}`}>
                <header
                  className="sz-co-step-header"
                  onClick={() => handleStepClick("address")}
                >
                ...
                {activeStep !== "address" && addressComplete && (
                  <div className="sz-co-step-preview">
                    <div className="sz-co-preview-info">
                      <strong>{fullName}</strong>
                      {addressPreview} · Phone: +91 {phone}
                    </div>
                    <button
                      type="button"
                      className="sz-co-step-edit-btn"
                      onClick={() => {
                        setActiveStep("address");
                        setAddressEditing(true);
                      }}
              ...
              <div className={`sz-co-step-card ${activeStep === "review" ? "active" : ""} ${activeStep === "payment" ? "completed" : ""}`}>
                <header
                  className="sz-co-step-header"
                  onClick={() => handleStepClick("review")}
                >
                ...
                {/* Collapsed Step Preview */}
                {activeStep !== "review" && activeStep !== "address" && (
                  <div className="sz-co-step-preview">
                    <div className="sz-co-preview-info">
                      {items.length} item{items.length !== 1 ? "s" : ""} selected for delivery.
                    </div>
                    <button
                      type="button"
                      className="sz-co-step-edit-btn"
              ...
              <div className={`sz-co-step-card ${activeStep === "payment" ? "active" : ""}`}>
                <header
                  className="sz-co-step-header"
                  onClick={() => handleStepClick("payment")}
                >
                      ...
                      <div className="sz-co-pay-options-list">
                        ...
                        >
                          ...
                          <div className="sz-co-pay-tile-info">
                            ...
                            <span className="sz-co-pay-tile-desc">Pay instantly using your favorite UPI app</span>
                          </div>
                          ...
                          <div className="sz-co-upi-apps-row">
                            ...
                            {UPI_UNAVAILABLE && (
                              <div className="sz-co-upi-disabled-banner">
                                Direct UPI is under scheduled maintenance. Please pay via Cards or Net Banking.
                              </div>
                            )}
                          </div>
                        )}
                        ...
                        >
                          ...
                          <div className="sz-co-pay-tile-info">
                            ...
                            <span className="sz-co-pay-tile-desc">50+ major Indian banks supported</span>
                          </div>
                          <div className="sz-co-pay-tile-logos">
                            <SbiLogo />
                            <HdfcLogo />
                        ...
                        {paymentMethod === "COD" && (
                          <div className="sz-co-cod-captcha-panel">
                            {/* Standard Numeric CAPTCHA image box */}
                            <div
                            ...
                            <div className="sz-co-captcha-input-field">
                              <label htmlFor="codCaptcha">Enter Verification Code</label>
                              <input
                                id="codCaptcha"
                                type="text"
                                maxLength={3}
              ...
              <aside className="sz-co-summary-sidebar">
                <div className="sz-co-summary-card">
                  ...
                  {pricing.totalSavings > 0 && (
                    <div style={{ display: "flex", gap: "0.5rem", fontSize: "0.85rem", color: "#10b981", fontWeight: "600", marginBottom: "1rem" }}>
                      <FaTag />
                      <span>
                        Savings of ₹{pricing.totalSavings.toLocaleString("en-IN")} applied
                      </span>
                    </div>
                  )}
