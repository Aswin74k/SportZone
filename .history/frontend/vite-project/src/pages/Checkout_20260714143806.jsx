      ...
      <StoreShell>
        <div className="sz-co-wrap">
          <div className="sz-co-empty-wrapper">
            ...
            <button type="button" className="sz-co-shop-redirect-btn" onClick={() => navigate("/shop")}>
              Browse Shop
            </button>
          </div>
        </div>
      ...
      <div className="sz-co-page">
                ...
                <div className="sz-co-summary-card">
                  ...
                  {pricing.totalSavings > 0 && (
                    <div className="sz-co-savings-banner">
                      ...
                      <span>
                        You are saving <strong>₹{pricing.totalSavings.toLocaleString("en-IN")}</strong> on this
                        order!
                      </span>
                    </div>
                  )}
        ...
        <div className="sz-co-mobile-bar d-lg-none">
          ...
          <motion.button
            ...
            disabled={payDisabled}
          >
            {loading ? <FaSpinner className="spin-icon" /> : paymentMethod === "COD" ? "Confirm Order" : "Proceed to Pay"}
          </motion.button>
        </div>
      </div>
    </StoreShell>
