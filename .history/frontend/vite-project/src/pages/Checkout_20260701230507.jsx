    ...
    <StoreShell>
      <div className="sz-co-page">
        <div className="sz-co-wrap">
          ...
          {/* horizontal progress stepper (redesigned and clean) */}
          <nav className="sz-co-progress" aria-label="Checkout progress">
            ...
            >
              <span className="sz-co-progress-dot">
                {addressComplete ? <FaCheck style={{ fontSize: "0.65rem" }} /> : "1"}
              </span>
            ...
            >
              <span className="sz-co-progress-dot">
                {activeStep === "payment" ? <FaCheck style={{ fontSize: "0.65rem" }} /> : "2"}
              </span>
