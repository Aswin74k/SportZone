                ...
                <div className="row g-0 align-items-center">
                  ...
                  <div className="col-md-5 p-3">
                    ...
                    <div className="text-muted small mb-2 d-flex flex-wrap gap-3">
                      <span>Category: <span className="fw-medium text-dark">{item.product?.category}</span></span>
                      {(item.size || item.product?.size) && (
                       br <span>Size: <span className="fw-medium text-dark">{item.size || item.product.size}</span></span>
                      )}
                    </div>
