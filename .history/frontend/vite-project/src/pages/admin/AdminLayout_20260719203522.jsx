    ...
    <div className="admin-shell">
      ...
      <aside className={`admin-sidebar ${sidebarOpen ? "open" : ""}`}>
        ...
        <div className="admin-sidebar-footer">
          ...
          <button type="button" className="btn btn-outline-secondary btn-sm w-10 d-flex align-items-center justify-content-center gap-2" onClick={() => navigate("/")} style={{ color: "rgba(255,255,255,0.8)", borderColor: "rgba(255,255,255,0.15)", background: "rgba(255,255,255,0.02)" }}>
