              ...
              <div className="modal-body p-4">
                ...
                >
                  <div className="p-3 flex-fill" style={{ minWidth: "180px", borderRight: "1px solid var(--admin-border)" }}>
                    ...
                    <div className="d-flex align-items-center gap-2">
                      <span
                        className="admin-user-avatar flex-shrink-0"
                        style={{ width: "30px", height: "30px", fontSize: "0.7rem", background: "linear-gradient(135deg, var(--admin-brand), var(--admin-brand-sky))" }}
                      >
                        {getInitials(viewOrder.shipping_name || viewOrder.user_email)}
                      </span>
                      <div className="min-w-0">
                        <div
                          className="fw-bold text-dark text-truncate"
                          style={{ maxWidth: "160px", cursor: "pointer" }}
                          title={`Click to copy: ${viewOrder.user_email}`}
                          onClick={() => copyToClipboard(viewOrder.user_email, "Email")}
                        >
                ...
                <div className="row g-4">
                  ...
                  <div className="col-md-5">
                    ...
                    >
                      <div className="d-flex align-items-center gap-2 mb-3 pb-3 border-bottom" style={{ borderColor: "var(--admin-border)" }}>
                        <span
                          className="admin-user-avatar flex-shrink-0"
                          style={{ width: "34px", height: "34px", fontSize: "0.78rem", background: "linear-gradient(135deg, var(--admin-brand-navy), var(--admin-muted))" }}
                        >
                          {getInitials(viewOrder.shipping_name)}
                        </span>
                        <div className="min-w-0">
                      ...
                      <div
                        className="d-flex align-items-center justify-content-between gap-2 text-muted small pt-2 border-top"
                        style={{ borderColor: "var(--admin-border)", cursor: "pointer" }}
                        onClick={() => copyToClipboard(viewOrder.shipping_phone, "Phone number")}
                        title="Click to copy"
                      >
