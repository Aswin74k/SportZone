...
export default function AdminLayout() {
  ...
  const userInitials = user?.name ? user.name.slice(0, 2) : (user?.username ? user.username.slice(0, 1) : "SU");
    ...
    <div className="admin-shell">
      ...
      <aside className={`admin-sidebar ${sidebarOpen ? "open" : ""}`}>
        ...
        <div className="admin-sidebar-footer">
          ...
          <button
            type="button"
            className="admin-back-to-store-btn"
            onClick={() => navigate("/")}
          >
            <span className="admin-back-to-store-icon" aria-hidden="true">
              <FaStore />
            </span>
