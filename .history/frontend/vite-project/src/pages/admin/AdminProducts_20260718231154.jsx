    ...
    <div>
      ...
      <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-3">
        ...
        <div className="d-flex flex-wrap gap-2">
          <div>
            <label className="form-label small mb-1" htmlFor="productSearchInput">Search by product name</label>
            <input
          ...
          <div>
            <label className="form-label small mb-1" htmlFor="categoryFilterSelect">Filter by category</label>
            <select
