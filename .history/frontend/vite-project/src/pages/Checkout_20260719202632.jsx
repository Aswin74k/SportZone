...
const DELIVERY_ESTIMATE_DAYS = 4;
...
export default function Checkout() {
      ...
      <StoreShell>
        <div className="sz-co-wrap">
          <div className="sz-co-empty-wrapper">
            ...
            <p>
              Some items in your cart are no longer available. Please return to the shop and
  ...
  // UPI is intentionally kept selectable (to show the "currently unavailable"
  // banner) but never allowed to actually submit an order.
  const payDisabled =
    loading ||
    activeStep !== "payment" ||
    paymentMethod === "UPI" ||
            ...
            <div className="sz-co-left-col">
              ...
              >
                {activeStep === "address" ? (
                  <>
                    <header
                      className="sz-co-step-header active"
                    ...
                    >
                      ...
                      {addresses.length > 0 && !addressEditing && (
                        <div className="sz-co-address-grid">
                          {addresses.map((addr) => {
                            const isHome =
                              addr.address_type?.toUpperCase() === "HOME" || !addr.address_type;
                          ...
                          <div className="sz-co-form-grid">
                            ...
                            <div className="sz-co-form-actions-row">
                              <div className="sz-co-addr-type-selector">
                                ...
                                <button
                                  type="button"
                                  className={`sz-co-type-btn ${
                                    addressType === "HOME" ? "active" : ""
                                  }`}
                                  onClick={() =>
                                    setValue("addressType", "HOME", { shouldDirty: true })
                                  }
                                >
                                  Home
                                </button>
                                <button
                                  ...
                                  onClick={() =>
                                    setValue("addressType", "WORK", { shouldDirty: true })
                                  }
                                >
                                  Work
                                </button>
                        ...
                        >
                          <div className="sz-co-pay-tile-left">
                            ...
                            <div className="sz-co-pay-tile-info">
                              ...
                              <span className="sz-co-pay-tile-desc">
                        ...
                        >
                          <div className="sz-co-pay-tile-left">
                            ...
                            <div className="sz-co-pay-tile-info">
                              ...
                              <span className="sz-co-pay-tile-desc">
                                Pay cash or scan QR when package arrives
                              </span>
                            </div>
                          </div>
                          <div className="sz-co-pay-tile-logos">
                            ...
                            <div className="sz-co-captcha-flex">
                              ...
                              <div className="sz-co-captcha-input-field">
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setCodCaptchaInput(e.target.value.replace(/\D/g, ""))
                                  }
                                />
                              </div>
                            </div>
                ...
                <div className="sz-co-summary-card">
                  ...
                  {pricing.totalSavings > 0 && (
                    <div className="sz-co-savings-banner">
                      ...
                      <span>
                        You are saving{" "}
                        <strong>₹{pricing.totalSavings.toLocaleString("en-IN")}</strong> on this
                        order!
                      </span>
                    </div>
                  )}
